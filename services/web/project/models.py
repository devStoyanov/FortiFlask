...
class Contacts(db.Model):
    ...
    name = db.Column(db.String(20), default=None, nullable=True)
    first_name = db.Column(db.String(20), default=None, nullable=True)
    last_name = db.Column(db.String(20), default=None, nullable=True)
    title = db.Column(db.String(20), default=None, nullable=True)
    email = db.Column(db.String(20), default=None, nullable=True)
